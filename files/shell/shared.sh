...
if [ -f "/etc/ssl/certs/ca-certificates.crt" ]; then
	...
	export REQUESTS_CA_BUNDLE="$DOTFILES/files/certs-keys/STRATEC-Chain.crt"
	export SSL_CERT_FILE="$DOTFILES/files/certs-keys/STRATEC-Chain.crt"
	export NODE_EXTRA_CA_CERTS="$DOTFILES/files/certs-keys/STRATEC-Chain.crt"
fi
...
alias radian='clear && radian  --ask-save --save --restore-data --debug'
